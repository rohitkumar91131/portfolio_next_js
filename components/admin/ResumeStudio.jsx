...
const LINKEDIN_URL =
  "https://www.linkedin.com/in/rohit-kumar-114037328/";
...
export default function ResumeStudio() {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        const [projectsRes, experienceRes, educationRes] =
          await Promise.all([
            fetch("/api/projects"),
        ...
        const [projectsData, experienceData, educationData] =
          await Promise.all([
            projectsRes.json(),
            experienceRes.json(),
            educationRes.json(),
    ...
    const generate = async () => {
      ...
      try {
        ...
        const visibleProjects =
          featured.length > 0 ? featured : active;
        ...
        /*
         * IMPORTANT:
         * We intentionally pass the COMPLETE project objects here.
         *
         * That means ResumeDocument receives:
         *
         * project.title
         * project.description
         * project.tech
         ...
         * project.liveLink
         *
         * ResumeDocument is responsible for rendering
         * GitHub / Live as clickable PDF links.
         */
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black">
      ...
      <main className="mx-auto max-w-5xl px-6 py-10 pb-24">
        <Link
          href="/admin/resumes"
          className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 mb-6"
        >
          <ArrowLeft size={18} />
          Back to Resumes
        </Link>
        ...
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Generated from your live portfolio data —
        ...
        <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-900/40 rounded-xl text-sm text-gray-700 dark:text-gray-300">
          ...
          <ol className="list-decimal ml-5 space-y-0.5">
            ...
            <li>
              Upload it to Cloudinary (or your file host)
            ...
            <li>
              ...
              , paste the URL and mark it primary —
              the site's Download Resume button updates instantly.
            </li>
          </ol>
        </div>
      </main>
